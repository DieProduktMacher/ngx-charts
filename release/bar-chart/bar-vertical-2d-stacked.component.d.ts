...
export declare class BarVertical2DStackedComponent extends BaseChartComponent {
    legend: boolean;
    legendTitle: string;
    ...
    getYScale(): any;
    getGroupDomain(): any[];
    getGroupStackedDomain(): any[];
    getInnerDomain(): any[];
    getInnerStackedDomain(): any[];
    getValueDomain(): number[];
    getValueStackedDomain(): number[];
