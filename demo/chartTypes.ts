const chartGroups = [
  {
    ...
    charts: [
      ...
      {
        name: 'Grouped Vertical Stacked Bar Chart',
        selector: 'bar-vertical-2d-stacked',
        inputFormat: 'groupedStackedBarChart',
        options: [
          'animations',
          'colorScheme',
          'schemeType',
  ...
  },
  {
    ...
    charts: [
      ...
      {
        name: 'Area Ridge Chart',
        selector: 'area-chart-ridge',
        inputFormat: 'multiSeries',
        options: [
          'animations',
          'colorScheme',
